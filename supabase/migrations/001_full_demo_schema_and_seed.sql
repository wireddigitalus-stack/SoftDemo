...
INSERT INTO allowed_users (id, email, name, role, active, pin, created_at) VALUES
  ('demo-admin-user', 'demo@visionpip-demo.com', 'Demo Admin', 'admin', true, NULL, '2026-05-14T04:45:29.326Z'),
  ('worker-john', 'john@visionpip-demo.com', 'John W. (Maintenance)', 'maintenance', true, '111111', '2026-05-16T04:45:29.326Z'),
  ('worker-mary', 'mary@visionpip-demo.com', 'Mary S. (Cleaning)', 'cleaning', true, '222222', '2026-05-16T04:45:29.326Z');
...
INSERT INTO leads (id, timestamp, name, email, phone, space_type, budget, timeline, team_size, score, score_label, reasoning, matched_properties, is_whale, whale_tier, whale_keywords, source, medium, campaign, additional_info, archived_at) VALUES
  (
    ...
    91,
    'Hot Lead',
    'Strong budget ($2,800/mo), urgent timeline, and team size of 2-4 match the Metro Park Professional Suites perfectly. Property has premium office options and immediate availability.',
    '[{"id":"metro-park","name":"Metro Park Professional Suites","type":"Office","sqft":"120 – 6,000","matchReason":"All-inclusive pricing covers utilities, fits 2-4 people nicely."}]'::jsonb,
    false,
    NULL,
    '[]'::jsonb,
    'organic',
  ...
  (
    ...
    64,
    'Warm Lead',
    'Solo designer seeking coworking setup. Summit CoWork memberships are available immediately. Good candidate for dedicated desk or private single office.',
    '[{"id":"summit-cowork","name":"Summit CoWork","type":"CoWorking","sqft":"5,000+","matchReason":"Fully furnished private offices, dedicated desks, high-speed internet."}]'::jsonb,
    false,
    NULL,
    '[]'::jsonb,
    'social',
  ...
  (
    ...
    '[{"id":"commerce-park","name":"Commerce Park — Offices & Warehouse","type":"Mixed-Use / Industrial","sqft":"8,000 Office + 45,500 Warehouse","matchReason":"Coca-Cola facility has 45k sqft warehouse, high ceilings, loading docks."}]'::jsonb,
    true,
    'gold',
...
INSERT INTO tenants (id, name, contact_name, email, phone, building, unit, rep, monthly_rent, utilities_fee, security_deposit, nnn_fee, cleaning_fee, cam_fee, nn_fee, lease_start, lease_end, renewal_date, lease_alert_days, escalation_pct, escalation_date, status, notes, source_lead_id, created_at) VALUES
  (
    ...
    'Jessica Morgan',
    'jmorgan@valleycatering.com',
    '423-555-1022',
    'Metro Park Professional Suites',
    'Suite 100',
    'Jessica Morgan',
  ...
  (
    ...
    'Summit Law Group',
    'Brian Thompson, Esq.',
    'bthompson@summitlaw.com',
    '276-555-9012',
    'Madison Square at Oakley',
    'Suite 300',
    'Alex Harrison',
  ...
  (
    ...
    '{
      "slides": [
        ...
        {
          "type": "property",
          "propertyId": "summit-cowork",
          "label": "Summit CoWork",
          "location": "450 Market Street, Ashton, TN 37601",
          "enabled": true,
          "order": 1
        },
        {
          "type": "property",
          "propertyId": "the-pinnacle",
        ...
        {
          "type": "property",
          "propertyId": "midtown-point",
          "label": "Centre Point",
          "location": "Ashton, VA (Entertainment District)",
          "enabled": true,
          "order": 3
        },
        {
          ...
          "label": "Riverside Court Apartments",
          "location": "Downtown Ashton, TN",
          "enabled": true,
          "order": 4
        },
...
INSERT INTO site_analytics (session_id, event_type, page_path, page_title, referrer, utm_source, utm_medium, utm_campaign, event_data, duration_ms, device_type, screen_width, created_at) VALUES
  ...
  (
    'session_mock_1',
    'cta_click',
    '/properties/metro-park',
    'Metro Park Professional Suites | Vision LLC',
    'https://www.google.com/',
    'google',
    'cpc',
    'bristol_cre',
...
INSERT INTO blog_posts (id, title, slug, summary, content, published, published_at, created_at) VALUES
  (
    'blog_1',
    'The Historical Transformation of Downtown Ashton',
    'historical-transformation-downtown-bristol',
    'Explore how adaptive reuse of 100-year-old structures is powering a modern economic boom along Market Street.',
    '<p>Downtown Ashton is experiencing a massive revival...</p>',
    true,
    '2026-05-29',
...
INSERT INTO activity_log (id, actor_email, actor_name, action, resource_type, resource_name, resource_id, metadata, created_at) VALUES
  (
    ...
    'Summit Law Group',
    'tenant_comm_2',
    '{"building":"Madison Square at Oakley","unit":"Suite 300","monthly_rent":2400}'::jsonb,
    '2026-06-08T04:45:29.326Z'
  ),
  (
    'act_2',
...
INSERT INTO properties (id, name, type, address, city, sqft, lease_status, badge, badge_color, description, features, images, hero_image, in_banner, published, created_at) VALUES
  (
    ...
    'Metro Park Professional Suites',
    'Office',
    '200 Commerce Ave., Ashton, TN 37601',
    'Ashton, TN',
    '120 – 6,000',
    'available',
    'Featured',
    '#4ADE80',
    'Metro Park Professional Suites is the Preservation Award-winning office address in the heart of Downtown Ashton — The Birthplace of Country Music. We offer premier office suites from 120 to 6,000 sqft with a professional environment that makes a great first impression on clients and business associates.',
    '["120 – 6,000 sqft Suites","All-Inclusive Pricing","CCTV Security","Fitness Access","Preservation Award Winner","Downtown Ashton","Single Offices Available"]'::jsonb,
    '["/property-images/commercial-metro-park-exterior.jpg","/property-images/commercial-vision-office.jpg"]'::jsonb,
    '/property-images/commercial-metro-park-exterior.jpg',
    true,
    true,
    '2026-05-14T04:45:29.326Z'
  ),
  (
    ...
    'Summit CoWork',
    'CoWorking',
    '450 Market Street, Ashton, TN 37601',
    'Ashton, TN',
    '5,000+',
    'available',
    'CoWork',
    '#FACC15',
    'Experience modern commercial leasing at Summit CoWork — a 5,000+ sqft facility at 620 Market Street offering fully furnished private offices, dedicated desks, and equipped conference rooms with high-speed internet and all utilities included.',
  ...
  (
    ...
    'Riverside Court Apartments',
    'Residential',
    '185 River Walk Dr., Ashton, TN 37601',
    'Ashton, TN',
    '900 – 1,400',
    'available',
    'Multi-Tenant',
    '#60A5FA',
    'Riverside Court Apartments offers premium multi-tenant residential living in Downtown Ashton. Meticulously maintained units featuring 1-2 bedrooms, modern kitchens, off-street parking, and walking distance to Market Street.',
  ...
  (
    ...
    'Highland Ridge Townhomes',
    'Residential',
    '720 Highland Blvd., Ashton, VA 24210',
    'Ashton, VA',
    '1,200 – 1,800',
    'available',
    'Virginia Side',
    '#FACC15',
    'Virginia Heights features beautiful townhouses located near the exit 5 corridor, offering easy access to both I-81 and Downtown Ashton VA. Spacious layouts with private garages.',
