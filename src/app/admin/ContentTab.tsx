...
const DEFAULTS: Record<string, Record<string, { label: string; value: string; type: "text" | "textarea" | "number" }>> = {
  hero: {
    trust_badge: { label: "Trust Badge Text", value: "#1 Commercial Property Owner in Downtown Ashton", type: "text" },
    ...
    subtext: { label: "Subtext / Description", value: "Vision LLC has been building Downtown Ashton — and serving businesses across the entire Tri-Cities region — for over 20 years. Office. Retail. Warehouse. Development. Executive Advisement.\nOne team. One vision.", type: "textarea" },
  ...
  stats: {
    ...
    stat_2_label: { label: "Stat 2 — Label", value: "Largest Private CRE Owner in Downtown Ashton", type: "text" },
  ...
  services: {
    ...
    card_3_desc: { label: "Card 3 — Full Description", value: "CEO J. Alex Harrison brings 30+ years of executive experience to provide unfiltered, results-driven advisement for corporations, government agencies, and emerging businesses.", type: "textarea" },
  },
  cta: {
  ...
  testimonials: {
    ...
    location_1: { label: "Review 1 — Location", value: "Bristol, TN/VA", type: "text" },
    quote_2: { label: "Review 2 — Quote", value: "Summit CoWork gave our startup the professional environment we needed without the overhead of a traditional lease. The team at Vision is genuinely invested in your success.", type: "textarea" },
    ...
    quote_3: { label: "Review 3 — Quote", value: "The executive advisement division is unlike anything I've experienced. J. Alex Harrison brings 30 years of real leadership to the table — strategy, not just platitudes.", type: "textarea" },
  ...
  faq: {
    ...
    q_1: { label: "FAQ 1 — Question", value: "How much does it cost to rent office space in Bristol, TN/VA?", type: "text" },
    a_1: { label: "FAQ 1 — Answer", value: "Office space in Downtown Ashton, TN/VA typically ranges from $8–$22/sqft annually depending on location, size, and finish level.", type: "textarea" },
    q_2: { label: "FAQ 2 — Question", value: "Is coworking space available in Bristol, TN/VA?", type: "text" },
    a_2: { label: "FAQ 2 — Answer", value: "Yes — Summit CoWork at 450 Market Street is Downtown Ashton's premier coworking facility.", type: "textarea" },
    q_3: { label: "FAQ 3 — Question", value: "What commercial real estate is available in the Tri-Cities region?", type: "text" },
    a_3: { label: "FAQ 3 — Answer", value: "Vision LLC is the largest private commercial real estate owner in Downtown Ashton, TN/VA.", type: "textarea" },
    q_4: { label: "FAQ 4 — Question", value: "How do I find retail space for lease in Bristol, TN?", type: "text" },
    a_4: { label: "FAQ 4 — Answer", value: "Vision LLC manages high-traffic retail storefronts on State Street and throughout Downtown Ashton.", type: "textarea" },
    q_5: { label: "FAQ 5 — Question", value: "Does Vision LLC serve Johnson City and Kingsport?", type: "text" },
    a_5: { label: "FAQ 5 — Answer", value: "Yes. While our primary portfolio is centered in Downtown Ashton, Vision LLC provides services across the entire Tri-Cities region.", type: "textarea" },
  ...
  about: {
    ...
    hero_heading_2: { label: "Hero Heading (highlighted)", value: "Downtown Ashton", type: "text" },
    hero_subtext: { label: "Hero Subtext", value: "Vision LLC is the largest private commercial property owner in Downtown Ashton, TN — and the most integrated commercial real estate firm in the Tri-Cities.", type: "textarea" },
    leader_heading: { label: "Leadership Name", value: "J. Alex Harrison II", type: "text" },
    leader_bio_1: { label: "Leadership Bio (paragraph 1)", value: "J. Alex Harrison II is the CEO of Vision LLC and one of the most respected commercial real estate leaders in the Tri-Cities region.", type: "textarea" },
