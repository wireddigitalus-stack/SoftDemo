...
export const metadata: Metadata = {
  ...
  description:
    "Browse Vision LLC's commercial properties in Bristol TN/VA — office suites, retail storefronts, coworking, mixed-use & industrial. Downtown Ashton's largest private owner. Call 423-573-1022.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Executive offices, retail storefronts, coworking, mixed-use & industrial space in Downtown Ashton, TN/VA. Tri-Cities #1 private commercial property owner. 423-573-1022.",
  ...
  twitter: {
    ...
    description:
      "Browse 50+ commercial properties in Downtown Ashton & the Tri-Cities. Office, retail, coworking & industrial. Call 423-573-1022.",
    images: [
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Browse available commercial properties in Downtown Ashton and the Tri-Cities TN/VA region.",
            url: "https://www.teamvisionllc.com/commercial-real-estate",
            numberOfItems: 9,
